...
trade_path = r'C:\\albino\\My-albo\\ExcelCalculate\\media\\' # \\ 두 개씩 써주기
TRAIN_DATA_DIR = 'C:\\albino\\My-albo\\ExcelCalculate\\media\\data\\train\\' #기존 데이터
VALIDATION_DATA_DIR = 'C:\\albino\\My-albo\\ExcelCalculate\\media\\data\\validation\\' #거래완료데이터
...
def train_and_save_model():
    ...
    model_final.save(r'C:\lbino\My-albo\ExcelCalculate\epoch100_1.h5')
    return None
